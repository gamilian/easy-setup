...
- The hardcoded clone URL (`github.com/lewislulu/terminal-setup.git`) appears in both the curl-pipe bootstrap and the READMEs; keep them consistent if the repo moves.
