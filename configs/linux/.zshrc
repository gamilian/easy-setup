#!/bin/zsh
# ─── terminal-setup: Zsh config (Linux) ─────────────────────────────
# Powered by: Starship + zsh-autosuggestions + zsh-syntax-highlighting + fzf + fnm

# ─── PATH ────────────────────────────────────────────────────────────
# Local bin holds batcat→bat / fdfind→fd symlinks and bundled binaries.
export PATH="$HOME/.local/bin:$PATH"
# fnm installs its binary here on Linux.
...
# Load at the very end so widgets from compinit / zle -N / other plugins
# are included in highlighting.
